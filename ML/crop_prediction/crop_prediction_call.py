...
header = ['Nitrogen','Phosporous','Potassium','pH','EC','OC','S','Zn','Fe','Cu','Mn','B'] 
...
path = "C:\Users\Aarav\Desktop\hcthn\crop\ML\crop_prediction\soil_analysis_1.pkl"
dt_model_final= joblib.load(path) 
...
testing_data = [['N','P','K','pH','EC','OC','S','Zn','Fe','Cu','Mn','B']]
